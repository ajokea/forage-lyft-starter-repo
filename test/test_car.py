...
class TestRorschach(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_rorsacch(last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
...
class TestThovex(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_thorex(last_service_date, current_mileage, last_service_mileage)
        self.assertTrue(car.needs_service())
