...
class CarFactory:
    ...
    def create_thorex(self, current_date, last_service_date, current_mileage, last_service_mileage):
    ...
    def create_rorsacch(self, current_date, last_service_date, current_mileage, last_service_mileage):
